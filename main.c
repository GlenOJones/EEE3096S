...
#define TIM2_TICKS_PIANO (TIM2CLK / (NS * FSIGNAL_PIANO))    // Piano uses full NS samples
#define TIM2_TICKS_GUITAR (TIM2CLK / (NS * FSIGNAL_GUITAR))  // Guitar uses full NS samples
#define TIM2_TICKS_DRUM (TIM2CLK / (NS * FSIGNAL_DRUM))      // Drum uses full NS samples
